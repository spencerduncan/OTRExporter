...
class Checksums(Enum):
    ...
    MM_US_GC = "B443EB08"
    MM_US_GC_AROENAI = "B5B62B48"  # Patched GC version
    MM_JP_GC = "8473D0C1"
...
ROM_INFO_TABLE[Checksums.MM_US_GC_AROENAI] = RomVersion("assets/extractor/filelists/mm_gc.txt", 0x1AE90, "GC_US", is_mm=True)
